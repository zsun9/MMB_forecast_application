...
% nominal rigidities
      zeta_p    = 0.5;    % price Calvo prametert
      iota_p    = 0;    % price indexation parameter
      zeta_w    = 0.1;    % wage Calvor parameter
      iota_w    = 0;    % wage indexation parameter
...
% other endogenous propagagion and steady state parameters
    ...
    sigmac    = 1.50;    % relative risk aversion
      ppsi      = 0.5;    % capital utilization cost
...
% nominal rigidities
zeta_p,BETA_PDF,0.5,0.02;  % price Calvo prametert
%zeta_w,BETA_PDF,0,0.02; % wage Calvo prametert
%iota_w,BETA_PDF,0,0.025;% price indexation  %originally fixed 0.5
%iota_p,BETA_PDF,0,0.025;% price indexation  %originally fixed 0.5
...
%ppsi,BETA_PDF,0,0.025;% capital utilization cost
