...
%%% observables %%%
    ...
    hours_obs_dngs           $L^{obs}$           % 29    => hours worked, observed
...
varobs gdp_rgd_obs hours_obs_dngs wage_obs pgdp_q_obs rff_q_obs pcer_q_obs fpi_q_obs cp_q_obs;
