...
% nominal rigidities
zeta_p,BETA_PDF,0.5,0.1;  % price Calvo prametert
zeta_w,BETA_PDF,0.5,0.1; % wage Calvo prametert
iota_w,BETA_PDF,0.5,0.15;% price indexation  %originally fixed 0.5
iota_p,BETA_PDF,0.5,0.15;% price indexation  %originally fixed 0.5
...
s2,NORMAL_PDF,4,1.5;% second derivative investment adjustment cost
sigmac,NORMAL_PDF,1.50,0.37 ;% relative risk aversion
ppsi,BETA_PDF,0.5,0.15;% capital utilization cost
...
estimation(nodisplay, smoother, order=1, prefilter=0, mode_check, bayesian_irf, datafile=data_20010815, xls_sheet=s4, xls_range=B1:AY101, presample=4, mh_replic=1000000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, sub_draws=5000, forecast=40, mode_compute=0, mode_file=DNGS15_mode) gdp_rgd_obs;