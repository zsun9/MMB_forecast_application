...
%                 end
                ...
                if model == "QPM08" || model == "QPM08_cql"
                    ...
                    if scenario == "s1" % in scenario 1, first GDP forecast is nowcast
                        ...
                        t.output.forecast.gdp = [oo_.SmoothedVariables.Mean.gdp_rgd_demean_obs(end-1:end)', oo_.MeanForecast.Mean.gdp_rgd_demean_obs(1:end-1)'];
                    end
                end
