...
estimation(datafile = data_20110701, xls_range=A1:X103, order = 1, smoother, mh_replic = 10000, mh_nblocks = 1, mh_jscale = 0.28,  mode_compute = 7, forecast = 5, nograph) gdp_rgd_obs;
