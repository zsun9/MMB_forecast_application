...
var hobsgm robs piobs dy dc dfi dw ewma epinfma y inv ext_pr pinf c lev q Lambda ell eta v rk invss z s mu n n_e lend u    
...
stoch_simul(irf=20,nograph)y inv pinf c robs q n ext_pr;