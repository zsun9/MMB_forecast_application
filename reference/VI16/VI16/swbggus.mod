...
var   hobsgm robs piobs dy dc dfi dw  ewma epinfma  uf rkf kf qf cf invf yf ellf wf rf 
...
IOTA_Y,        -0.0421 ,-0.065 ,0.5,GAMMA_PDF,.125,0.05;
...
ctrend,       0.1960 ,0.1,0.8,NORMAL_PDF,0.4,0.10;
...
% lik_init=2,prefilter=0,conf_sig=0.95,mh_replic=0,mh_nblocks=2,mh_jscale=0.35,mh_drop=0.25) y inv  ext_pr pinf robs n q k c rk;

% conditional_variance_decomposition=[1 4 8 40 80],
stoch_simul(irf=20,nograph ) y inv ext_pr pinf robs n q k c rk ;
