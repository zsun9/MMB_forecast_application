function [vardata] = getdata(pinvestment,money,period,FR,sm,product,hours,vver)
...
if vver == 0
    ...
    GCD         =   nomdata(12,8:227)';
    GCN         =   nomdata(13,8:227)';
    GCS         =   nomdata(14,8:227)';
    GPI         =   nomdata(15,8:227)';
    GGE         =   nomdata(29,8:227)';
