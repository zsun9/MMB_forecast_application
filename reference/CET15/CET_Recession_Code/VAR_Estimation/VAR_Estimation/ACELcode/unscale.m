function unscale    =   unscale(zz,s,alpha,R,pie)
...
%unscale =   [output,mgrowth,infl,fedf,capa,hours,rwage,cons,invest,vel,pinv];
%modification by JL 11/1/04
unscale =   [output' mgrowth' infl' fedf' capa' hours' rwage' cons' invest' vel' pinv']';