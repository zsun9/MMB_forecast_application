function [ff,UcH, cH,gamma,alp1,alp2,alp3,alp4,V,A,U,N,K,F,...
    psi,omega,pl]=find_paras(xx,s,e,wp,delta,M,J,varthet,y,xi,pibar,L,l,c,...
    b,D,rho,betta,f,mu,Fcal,FcalL,FcalprimeL,nD,nGAM,nH,lambda,mc,...
    pitilde,w,m,chi)
...
psi=(1-omega)*ctilde^(-chi)*(c*(1-b/mu))^(chi-1);
