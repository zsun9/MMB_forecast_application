...
%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
global M_ options_ oo_ horizon logdetVhat Vhat inv_Vhat psihat data_varnames horizon mod_var_list mod_shock_list doMonetaryShockonly
...
for jj=i_var_exo,    
    ...
    %mod_var_list=[{'GDPAGG'} {'piAGG'} {'RAGG'} {'lAGG'} {'wAGG'}  {'cAGG'}  {'iAGG'} {'pinvestAGG'}  {'unempAGG'} {'vTotAGG'} {'fAGG'} {'ukAGG'} {'muF'} {'mupsiF'}];
    ...
    if jj==1, %monetary shock
        ...
        psitheta_mon(2:end,12)=yFF(2:end,12)*M_.params(loc(M_.param_names,'f'));%finding rate
    ...
    if jj==2, %neutral tech shock
        ...
        psitheta_ntech(1:end,12)=yFF(1:horizon,12)*M_.params(loc(M_.param_names,'f'));%finding rate
    ...
    if jj==3, %invest tech shock
        ...
        psitheta_itech(1:end,12)=yFF(1:horizon,12)*M_.params(loc(M_.param_names,'f'));%finding rate
