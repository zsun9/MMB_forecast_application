...
//                                                                      //
//Parameters here are set so that the general wage rule model is active.//
//That is, the AOB sharing rule is replaced by the general wage rule as //
//in the main text. The model is estimated and results are reproduced.  //
//////////////////////////////////////////////////////////////////////////
...
unemp_SS vTot_SS alp1 alp2 alp3 alp4 bet1 bet2 bet3 s searchSHAREpercent bet4 bet5
bet6,bet7,bet8,bet9,bet10;
...
//R21 Sharing rule
//see below for general wage rule
...
//General Wage Rule 
wF                   =  STEADY_STATE(wF)    
+  bet1  *(  RF(-1)                -STEADY_STATE(  RF(-1)                ))  
+  bet2  *(  kbarF(-1)             -STEADY_STATE(  kbarF(-1)             ))  
+  bet3  *(  lF(-1)                -STEADY_STATE(  lF(-1)                ))  
+  bet4  *(  phaloF(-1)            -STEADY_STATE(  phaloF(-1)            ))   
+  bet5  *(  nGF(-1)               -STEADY_STATE(  nGF(-1)               ))   
+  bet6  *(  cF(-1)                -STEADY_STATE(  cF(-1)                ))  
+  bet7  *(  iF(-1)                -STEADY_STATE(  iF(-1)                ))  
+  bet8  *(  muzF                  -STEADY_STATE(  muzF                  ))
+  bet9  *(  mupsiF                -STEADY_STATE(  mupsiF                ));
 

wR                   =  STEADY_STATE(wR)    
+  bet1  *(  RR(-1)                -STEADY_STATE(  RF(-1)                ))  
+  bet2  *(  kbarR(-1)             -STEADY_STATE(  kbarF(-1)             ))  
+  bet3  *(  lR(-1)                -STEADY_STATE(  lF(-1)                ))  
+  bet4  *(  phaloR(-1)            -STEADY_STATE(  phaloF(-1)            ))
     
+  bet6  *(  cR(-1)                -STEADY_STATE(  cF(-1)                ))  
+  bet7  *(  iR(-1)                -STEADY_STATE(  iF(-1)                ));
...
rhoR,,,,beta_pdf,0.7,0.15; 
rpi ,,,,gamma_pdf,1.7,0.15;
ry ,,,,gamma_pdf,0.1,0.05;

b,,,,beta_pdf,0.5,0.15;
sigmaa,,,,gamma_pdf,0.5,0.3; 
Spp,,,,gamma_pdf,8,2; 
alfa,,,,beta_pdf,0.33,0.025;
thetaG,,,,beta_pdf,0.5,0.2;
...
bet1	,,,,	uniform_pdf	,,,-0.487067871571285*3,0.487067871571285;	 
bet2	,,,,	uniform_pdf	,,,-0.063223892600000*3,0.063223892600000; 	 
bet3	,,,,	uniform_pdf	,,,-0.011862791931681*3,0.011862791931681;	 
bet4	,,,,	uniform_pdf	,,,-0.768200263717195*3,0.768200263717195;	 
bet5	,,,,	uniform_pdf	,,,-0.774474313386899,0.774474313386899*3;	 
bet6	,,,,	uniform_pdf	,,,-0.135991962557243,0.135991962557243*3;	 
bet7	,,,,	uniform_pdf	,,,-0.081153163652992,0.081153163652992*3; 	 
bet8	,,,,	uniform_pdf	,,,-0.970249157680448*3,0.970249157680448;	 
bet9	,,,,	uniform_pdf	,,,-0.228591702631231*3,0.228591702631231;	
end;     
