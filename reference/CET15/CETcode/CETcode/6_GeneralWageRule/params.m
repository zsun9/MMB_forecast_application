...
do_given_bets=1;  %if =1, given values for betas in general wage rule
bet1=  -0.487067871571285 ;
bet2=  -0.063223892600000 ;
bet3=  -0.011862791931681 ; 
bet4=  -0.768200263717195 ;  
bet5=  0.774474313386899  ;
bet6=  0.135991962557243  ;  
bet7=  0.081153163652992  ;  
bet8=  -0.970249157680448 ;
bet9=  -0.228591702631231 ;
...
DSHARE=0.43;             %unempl. benefits as share of w (replacement ratio)
...
if M<2, 
    error('M must be at least equal to 2!');
end
if mod(M,2)==1, error('M must be an even number so that the worker makes the last offer!');
end
...
iota=1;      %Parameter that does not appear in the model anymore. Just ignore it.
bet10=0;     %Parameter that does not appear in the model anymore. Just ignore it.
