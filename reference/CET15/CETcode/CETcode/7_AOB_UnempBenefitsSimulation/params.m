function [ydiffdataPercent,idiffdataPercent,alfa,rho,u,Q,sigma,pibar,betta,lambda,deltak,tau,nuf,...
    ...
    thetaKAP, thetaD, thetaGAM, do_given_bets,bet1,bet2,bet3,searchSHAREpercent,rhoD,sigD]=params


%model switches
doNash=0;    %if =0, alt offer barg. ; if =1, Nash bargaining; note: requires doEHL=0 below
doEHL=0;     %if=0, alt offer barg or Nash barg; if=1, Calvo Sticky Wages (EHL labor market)
...
rhoD        =   0.75;  %unemployment benefits





iota=1;      %a parameter that has no meaning and is not used in the code
