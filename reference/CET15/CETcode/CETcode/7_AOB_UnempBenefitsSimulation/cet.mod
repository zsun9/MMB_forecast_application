...
//                                                                      //
//Simulation of effects of unemployment benefits shock (figure 8)       //
//                                                                      //
//AOB model with estimated parameters (loaded from MCMC mean below)     //
//////////////////////////////////////////////////////////////////////////
...
// Unemployment benefits (exog process)
var DF; 

//Shocks
varexo epsR_eps muz_eps mupsi_eps D_eps zlbswitch D_ann_eps;
...
RF=zlbswitch*STEADY_STATE(RF) + (1-zlbswitch)*(rhoR*RF(-1)+(1-rhoR)*(STEADY_STATE(RF)+rpi*(piF-STEADY_STATE(piF))+ry*(GDPF-STEADY_STATE(GDPF))));
...
doEHL*(exp(UF)-exp(STEADY_STATE(UF)))=(1-doEHL)*(-exp(UF)+exp(DF)*exp(nDF)+betta*exp(psiF(+1))/exp(psiF)*(exp(fF(+1))*exp(VF(+1))+(1-exp(fF(+1)))*exp(UF(+1))));

//R21 Sharing rule
doEHL*(exp(varthetF)-STEADY_STATE(exp(varthetF)))=(1-doEHL)*(doNash*(exp(VF)-exp(UF)-eta*(exp(JF)+exp(VF)-exp(UF)))+(1-doNash)*(

-exp(JF)+bet1*(exp(VF)-exp(UF))-bet2*exp(nGAMF)*gamma+bet3*(exp(varthetF)-exp(nDF)*exp(DF))
...
DF=(1-rhoD)*STEADY_STATE(DF)+rhoD*DF(-1)+sigD/100*D_eps+sigD/100*D_ann_eps(-4);
...
var D_eps           = 1; //unemp. benefits (unexp.)
var D_ann_eps       = 1; //unemp. benefits (announced)
end;    
...
//load estimated AOB parameters
load cet_mh_mode.mat; %get joint MCMCM mode
...
options_.slowc=.5;
 ...
 //Do computations
xibase=M_.params(loc(M_.param_names,'xi'));
xialt=0.5;
rhoDbase=0.75;
rhoDalt=0.9;

/////////////////////////////////////////////
//Case1a: No ZLB, estimated price stickiness//
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xibase; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDbase; 
cet_steadystate;
steady;
shocks;         
//unempl. benefits
    var D_eps;
    periods 1:1;
    values(2.6749503887419);

    //impose constant interest rate
    var zlbswitch;
    periods 1:10000;
    values(0);
end;
simul(periods=300);
unemp.case1a=exp(unempF(1:30))*100;


/////////////////////////////////////////////
//Case1b: No ZLB, estimated price stickiness//
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xibase; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDalt; 
cet_steadystate;
steady;
shocks;         
//unempl. benefits
...
simul(periods=300);
unemp.case1b=exp(unempF(1:30))*100;
...
/////////////////////////////////////////////
//Case2a: No ZLB, low price stickiness      //
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xialt; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDbase; 
cet_steadystate;
steady;
shocks;         
...
simul(periods=300);
unemp.case2a=exp(unempF(1:30))*100;




/////////////////////////////////////////////
//Case2b: No ZLB, low price stickiness      //
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xialt; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDalt; 
cet_steadystate;
...
simul(periods=300);
unemp.case2b=exp(unempF(1:30))*100;



/////////////////////////////////////////////
//Case3a: 1Y ZLB, estimated price stickiness//
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xibase; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDbase; 
cet_steadystate;
...
simul(periods=300);
unemp.case3a=exp(unempF(1:30))*100;



/////////////////////////////////////////////
//Case3b: 1Y ZLB, estimated price stickiness//
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xibase; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDalt; 
cet_steadystate;
...
simul(periods=300);
unemp.case3b=exp(unempF(1:30))*100;
...
/////////////////////////////////////////////
//Case4a: 1Y ZLB, low price stickiness      //
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xialt; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDbase; 
cet_steadystate;
...
simul(periods=300);
unemp.case4a=exp(unempF(1:30))*100;


/////////////////////////////////////////////
//Case4b: 1Y ZLB, low price stickiness      //
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xialt; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDalt; 
cet_steadystate;
...
simul(periods=300);
unemp.case4b=exp(unempF(1:30))*100;
...
/////////////////////////////////////////////
//Case5a: 2Y ZLB, estimated price stickiness//
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xibase;
M_.params(loc(M_.param_names,'rhoD'))=rhoDbase;  
cet_steadystate;
...
simul(periods=300);
unemp.case5a=exp(unempF(1:30))*100;



/////////////////////////////////////////////
//Case5b: 2Y ZLB, estimated price stickiness//
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xibase;
M_.params(loc(M_.param_names,'rhoD'))=rhoDalt;  
cet_steadystate;
...
simul(periods=300);
unemp.case5b=exp(unempF(1:30))*100;
...
/////////////////////////////////////////////
//Case6a: 2Y ZLB, low price stickiness      //
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xialt; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDbase;  
cet_steadystate;
...
simul(periods=300);
unemp.case6a=exp(unempF(1:30))*100;
...
/////////////////////////////////////////////
//Case6b: 2Y ZLB, low price stickiness      //
/////////////////////////////////////////////
M_.params(loc(M_.param_names,'xi'))=xialt; 
M_.params(loc(M_.param_names,'rhoD'))=rhoDalt;  
cet_steadystate;
...
simul(periods=300);
unemp.case6b=exp(unempF(1:30))*100;
