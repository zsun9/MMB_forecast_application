...
if nargin==3 && check==0,
    ...
    fprintf('   bet1  = %6.4f,  bet2 = %6.4f,    bet3 = %6.4f\n\n',bet1,bet2,bet3)
    
    fprintf('   bet1red  = %6.4f,  bet2red = %6.4f,    bet3red = %6.4f, bet4red = %6.4f, bet2red+bet4red = %6.4f\n\n',bet1,-bet2*gamma,bet3,-bet3*D,-(bet2*gamma+bet3*D))
