...
doEHL=1;     %if=0, alt offer barg or Nash barg; if=1, EHL labor market
...
rpi     =	2.1;%1.3552;   %Coefficient on inflation
...
iota=1;      %parameter that is not part of the model anymore. Just ignore it.
