...
//                                                                      //
//Parameters in this code are set such that the EHL (sticky wages) model//
//is active. That model is estimated here and results are reproduced    //
//////////////////////////////////////////////////////////////////////////
...
%below parameter applies to EHL model only
sigmaL,,,,gamma_pdf,1,0.25;
end;      
