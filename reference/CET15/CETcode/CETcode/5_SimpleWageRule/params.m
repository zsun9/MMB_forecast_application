...
do_given_bets=1;  %if =1, given values for beta's in sharing/wage rule
bet1 = 0.9;    %Wage rule coefficients 
bet2 = .1;
bet3 = -0.1;
bet4 = -0.1; 
...
iota=1;      %Parameter does not appear in the model anymore. Just ignore it.
bet5 = 0;    %Parameter does not appear in the model anymore. Just ignore it.
