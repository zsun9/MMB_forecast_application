...
//                                                                       //
//Parameters here set so that the reduced form sharing rule is active.   //
//That is the coefficients of the AOB sharing rule are treated as reduced//
//form parameters and are estimated (see main text for details).         //
//                                                                       //      
//calculate_pvalues.m computes the p-values reported in table 4.         //
//                                                                       //
///////////////////////////////////////////////////////////////////////////
...
//R21 Sharing rule: reduced form -- parameters are treated as reduced form parameters (and are estimated below)
...
//F21 Sharing rule: reduced form -- parameters are treated as reduced form parameters (and are estimated below)
...
bet1,,,,normal_pdf,0.07,.5; 
bet3,,,,normal_pdf,0.47,.5; 
end;      
