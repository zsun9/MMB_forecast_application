...
//                                                                      //
//Parameters in this code are set such that the Nash Model is active.   //
//That model is estimated here and the code reproduces the results.     //
//////////////////////////////////////////////////////////////////////////
...
//uncomment this line and switch the comments in line 537 and 538 to get the Nash 
//model with lower replacement ratio, keeping all other parameters at estimated values
%M_.params(loc(M_.param_names,'DSHARE'))=0.368861073612840;
