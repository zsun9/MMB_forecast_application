...
%model switches
doNash=1;    %if =0, alt offer barg. ; if =1, Nash bargaining; note: requires doEHL=0 below
...
DSHARE=0.368861073612840;         %unempl. benefits as share of w (replacement ratio)
...
iota=1;      %This parameter does not enter the model anymore. Just ignore it.
