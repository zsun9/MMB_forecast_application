...
options_ = [];
M_.fname = 'Ajello_AER16';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('Ajello_AER16.log');
M_.exo_names = 'eps_z';
...
M_.exo_names = char(M_.exo_names, 'eps_sg');
M_.exo_names_tex = char(M_.exo_names_tex, 'eps\_sg');
M_.exo_names_long = char(M_.exo_names_long, 'eps_sg');
M_.endo_names = 'AI';
...
options_.varobs = [];
options_.varobs = 'd_GDP';
options_.varobs = char(options_.varobs, 'd_Ihat');
options_.varobs = char(options_.varobs, 'd_chat');
options_.varobs = char(options_.varobs, 'dlnwhat');
options_.varobs = char(options_.varobs, 'pi_ob_t');
options_.varobs = char(options_.varobs, 'i_ob_t');
options_.varobs = char(options_.varobs, 'l_ob_t');
options_.varobs = char(options_.varobs, 'Spread_ob_t');
options_.varobs = char(options_.varobs, 'FGS_obs');
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Ajello_AER16_static');
erase_compiled_function('Ajello_AER16_dynamic');
...
M_.Sigma_e(12, 12) = M_.params(43)^2;
...
estim_params_.param_vals = [estim_params_.param_vals; 5, 0.7355, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 7, 0.7296, 0, 1, 1, 0.60, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 9, 0.8829, 0, 1, 1, 0.75, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 10, 0.0965, 0, 1, 1, 0.50, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 12, 0.8940, 0, 1, 1, 0.75, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 13, 0.4723, 0, 1, 1, 0.50, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 15, 0.06, 0, 1, 2, 0.40, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 17, 0.5, 0, 1, 1, 0.75, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 2, 0, NaN, 2, 2, 0.40, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 21, 1.4534, 0, NaN, 2, 4, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 22, 0.5893, NaN, NaN, 2, 0.50, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 23, 0.9525, 0, 1, 1, 0.85, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 24, 0.5689, 0, NaN, 3, 0.70, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 25, 0.1152, NaN, NaN, 3, 0.125, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 27, 0.3, 0, NaN, 2, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 28, 0.3156, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 29, 0.9897, 0, 1.01, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 32, 0.6212, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 30, 0.95, NaN, NaN, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 31, 0.60, 0, NaN, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 33, 0.6182, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 34, 0.1874, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 35, 0.2155, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 36, 0.1161, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
...
options_.order = 1;
options_.periods = 0;
options_.conditional_variance_decomposition = 6;
var_list_=[];
var_list_ = 'd_GDP';
var_list_ = char(var_list_, 'd_Ihat');
var_list_ = char(var_list_, 'd_chat');
var_list_ = char(var_list_, 'dlnwhat');
var_list_ = char(var_list_, 'pi_ob_t');
var_list_ = char(var_list_, 'i_ob_t');
var_list_ = char(var_list_, 'l_ob_t');
var_list_ = char(var_list_, 'Spread_ob_t');
var_list_ = char(var_list_, 'FGS_obs');
...
options_.datafile = 'MYDATA_baseline';
options_.mode_file = 'Ajello_AER16_mode.mat';
var_list_=[];
var_list_ = 'd_GDP';
var_list_ = char(var_list_, 'd_Ihat');
var_list_ = char(var_list_, 'd_chat');
...
var_list_ = char(var_list_, 'd_Ihat');
var_list_ = char(var_list_, 'd_chat');
var_list_ = char(var_list_, 'ygap_t');
...
var_list_ = char(var_list_, 'Spread_ob_t');
var_list_ = char(var_list_, 'FGS_obs');
var_list_ = char(var_list_, 'GDP_t');
var_list_ = char(var_list_, 'Ihat');
var_list_ = char(var_list_, 'chat');
var_list_ = char(var_list_, 'what_t');
var_list_ = char(var_list_, 'z_t');
dynare_estimation(var_list_);
end
filename = ['Ajello_AER16_optim_ind_' int2str(optim_ind) '_' datestr(now,'yyyymmddTHHMMSS')]; 
save(filename);
save('Ajello_AER16_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Ajello_AER16_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Ajello_AER16_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Ajello_AER16_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Ajello_AER16_results.mat', 'estimation_info', '-append');
end
