function [nvar,vartan,NumberOfDecompFiles] = ...
    dsge_simulated_bc_variance_decomposition(SampleSize,M_,options_,oo_,type, bc_freq)
...
for file = 1:NumberOfDrawsFiles
    ...
    for linee = 1:NumberOfDraws
        ...
        tmp = th_autocovariances(dr,ivar,M_,options_,nodecomposition, bc_freq);
        for i=1:nvar
            for j=1:nexo
        ...
        if linea == NumberOfDecompLines
            if posterior
                save([M_.dname '/metropolis/' M_.fname '_PosteriorVarianceDecomposition_bc' int2str(DecompFileNumber) '.mat' ],'Decomposition_array');
            else
                save([M_.dname '/prior/moments/' M_.fname '_PriorVarianceDecomposition_bc' int2str(DecompFileNumber) '.mat' ],'Decomposition_array');
            end
