...
if isfield(oo_, [ TYPE 'TheoreticalMoments'])
    ...
    if isfield(temporary_structure,'dsge')
        ...
        if isfield(temporary_structure,'VarianceDecomposition_bc')
            eval(['temporary_structure = oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.Mean;'])
...
ListOfFiles = dir([ PATH  fname '_' TYPE 'VarianceDecomposition_bc*.mat']);
...
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.Mean.' name ' = p_mean;']);
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.Median.' name ' = p_median;']);
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.Variance.' name ' = p_var;']);
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.HPDinf.' name ' = hpd_interval(1);']);
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.HPDsup.' name ' = hpd_interval(2);']);
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.deciles.' name ' = p_deciles;']);
eval(['oo_.' TYPE 'TheoreticalMoments.dsge.VarianceDecomposition_bc.density.' name ' = density;']);