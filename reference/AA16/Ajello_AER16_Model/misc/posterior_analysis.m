...
%         bc_freq = 1
%         [nvar_bc,vartan_bc,NumberOfFiles_bc] = ...
%             dsge_simulated_bc_variance_decomposition(SampleSize,M_,options_,oo_,'posterior', bc_freq);
    end
...
%     oo_ = variance_decomposition_mc_bc_analysis(SampleSize,'posterior',M_.dname,M_.fname,...
%                                              M_.exo_names,arg2,vartan_bc,arg1,options_.mh_conf_sig,oo_);
  case 'correlation'
    if nargin==narg1
        [nvar,vartan,NumberOfFiles] = ...
