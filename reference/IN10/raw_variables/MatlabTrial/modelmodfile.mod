...
estimation(datafile='maunal_data_trial.xlsx',  bayesian_irf,irf=20, conf_sig=0.95, smoother, mh_jscale=0.2, mode_compute=4, presample=4,  prior_trunc=1e-100, mh_replic=5000, mh_nblocks=1,  forecast=40,  lik_init=1) 
