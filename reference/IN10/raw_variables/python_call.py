...
main(vintageDate = '2007-05-21', quarterStart = '1965Q1', quarterEnd = '2006Q4', raw = [], observed = ['rc_obs', 'pi_dm_obs','rri_obs','rbi_obs','hwc_pd_obs', 'hwr_pd_obs', 'hp_r_obs', 'i_nom_obs', 'c_winf_obs' ,'h_winf_obs'], showRawTransform=False, pathExcel = None, onlyS3 = False)
