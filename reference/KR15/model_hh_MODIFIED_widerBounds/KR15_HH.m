...
M_.endo_names_long = char(M_.endo_names_long, 'hours_kr15_obs');
...
options_.varobs(3)  = {'inr_nom_obs'};
options_.varobs(4)  = {'hours_kr15_obs'};
options_.varobs(5)  = {'wage_rgd_obs'};
options_.varobs(6)  = {'gdpdef_obs'};
options_.varobs(7)  = {'ffr_obs'};
options_.varobs(8)  = {'ir_nom_obs'};
options_.varobs(9)  = {'mortgage_nom_obs'};
options_.varobs(10)  = {'hp_nom_obs'};
options_.varobs(11)  = {'mortffr_obs'};
...
erase_compiled_function('KR15_HH_static');
...
options_.datafile = 'data_20081110';
options_.xls_range = 'B1:X101';
options_.xls_sheet = 's3';
var_list_ = char('gdp_rgd_obs');
oo_recursive_=dynare_estimation(var_list_);
save('KR15_HH_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('KR15_HH_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('KR15_HH_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('KR15_HH_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('KR15_HH_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('KR15_HH_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('KR15_HH_results.mat', 'oo_recursive_', '-append');
end
