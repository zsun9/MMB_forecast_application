function [residual, g1, g2] = dssw_ff_static(y, x, params)
%
...
T537 = (T76-y(3)*T25*getPowerDeriv(T25*y(3),params(11),1))/(T76*T76)/T83;
T544 = getPowerDeriv(T84,T97,1);
T556 = getPowerDeriv(T83*T76*T107,T110,1);
T559 = getPowerDeriv(T116,(-params(2)),1);
T572 = (T264-y(3)*getPowerDeriv(y(3),params(6),1))/(T264*T264)/T267;
...
T946 = (-(y(3)*T25*y(3)*getPowerDeriv(T25*y(3),params(11),1)))/(T76*T76)/T83;
T1064 = (exp(y(34))*(-exp(y(34)))-exp(y(34))*(-(1+exp(y(34)))))/(exp(y(34))*exp(y(34)));
T1102 = (exp(y(37))*0.5*exp(y(37))*2*exp(y(37))-exp(y(37))*(log(y(23))+0.5*exp(y(37))^2))/(exp(y(37))*exp(y(37)));
lhs =T27*y(2)/y(3);
rhs =1;
residual(1)= lhs-rhs;
lhs =y(1);
...
if nargout >= 2,
  ...
  g1(4,3)=(-(y(7)*exp(y(30)*T66)*beta__*params(10)*T537*getPowerDeriv(T84,T66,1)));
  ...
  g1(4,30)=(-(y(7)*(exp(y(30)*T66)*beta__*params(10)*getPowerDeriv(T84,T66,1)*T946+beta__*params(10)*T84^T66*T66*exp(y(30)*T66))));
  g1(4,32)=(-T71);
  g1(5,1)=(-(y(9)*T94));
  ...
  g1(6,3)=(-(params(10)*T83*(T107*T25*getPowerDeriv(T25*y(3),params(11),1)+T76*(-(y(6)/T25))/(y(3)*y(3)))*T556*T559));
  g1(6,5)=(-(T559*(1-params(10))*getPowerDeriv(y(5),T110,1)));
  g1(6,6)=1-T559*params(10)*T556*T83*T76*1/T25/y(3);
  g1(6,30)=(-(T559*params(10)*T556*T83*(T107*T25*y(3)*getPowerDeriv(T25*y(3),params(11),1)+T76*(-(T25*y(6)))/(T25*T25)/y(3))));
  ...
  g1(8,1)=(-(y(13)*T132*params(7)*T131^2*exp(y(33))*T491));
  g1(8,13)=(-(exp(y(33))*(T135-T132*params(7)*T131)+T132*params(7)*T27*exp(y(33))*T131^2));
  g1(8,30)=(-(y(13)*exp(y(33))*((-(params(7)/2*T131*2*T132))-(T132*params(7)*T131+T131*params(7)*T131))+y(13)*(T131*params(7)*T27*exp(y(33))*T131^2+T132*params(7)*(T131^2*exp(y(33))*T927+T27*exp(y(33))*T131*2*T131))));
  g1(8,33)=(-T152);
  g1(9,11)=(-y(13));
  g1(9,13)=(-y(11));
  g1(9,14)=1;
  ...
  g1(26,29)=1-T353;
  g1(26,34)=(-((1-params(5))*y(25)^T347*log(y(25))*T1064+y(29)*params(5)*T352*T1064*log(T264*T267/y(3))));
  g1(27,20)=1;
  g1(27,23)=(-(T861*T868));
  g1(27,37)=(-(T868*T1102));
  g1(28,21)=1;
