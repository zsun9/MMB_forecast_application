...
M_.aux_vars = [];
options_.varobs = [];
options_.varobs = 'dlnY';
options_.varobs = char(options_.varobs, 'dlnC');
options_.varobs = char(options_.varobs, 'dlnIf');
options_.varobs = char(options_.varobs, 'lnL');
options_.varobs = char(options_.varobs, 'dlnw');
options_.varobs = char(options_.varobs, 'dlnP');
options_.varobs = char(options_.varobs, 'FedFunds');
options_.varobs = char(options_.varobs, 'dlnIo');
options_.varobs = char(options_.varobs, 'dlnDin');
options_.varobs = char(options_.varobs, 'dlnPo');
options_.varobs = char(options_.varobs, 'Spreadi');
...
var_list_=[];
var_list_ = 'dlnY';
var_list_ = char(var_list_, 'dlnC');
var_list_ = char(var_list_, 'dlnI');
var_list_ = char(var_list_, 'dlnw');
var_list_ = char(var_list_, 'lnL');
var_list_ = char(var_list_, 'dlnP');
var_list_ = char(var_list_, 'FedFunds');
