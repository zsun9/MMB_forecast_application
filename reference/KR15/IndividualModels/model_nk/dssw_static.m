function [residual, g1, g2] = dssw_static(y, x, params)
%
...
T71 = exp(y(25))*y(6)^T66*y(9)^(1+params(9));
...
T152 = exp(y(26))*(T135-T132*params(7)*T131)*y(13)+y(13)*T132*params(7)*T27*exp(y(26))*T131^2;
...
residual(3)= lhs-rhs;
lhs =y(7);
rhs =T71+y(7)*beta__*params(10)*T84^T66*exp(y(23)*T66);
residual(4)= lhs-rhs;
lhs =y(8);
...
residual(16)= lhs-rhs;
lhs =1;
rhs =params(5)*T234+(1-params(5))*y(18)^T233;
residual(17)= lhs-rhs;
lhs =y(2)/(y(2));
rhs =T244*T254*T259;
residual(18)= lhs-rhs;
...
residual(21)= lhs-rhs;
lhs =y(22);
rhs =(1-params(5))*y(18)^T292+y(22)*T298;
residual(22)= lhs-rhs;
lhs =y(23);
...
if nargout >= 2,
  ...
  g1(4,3)=(-(y(7)*exp(y(23)*T66)*beta__*params(10)*T422*getPowerDeriv(T84,T66,1)));
  g1(4,6)=(-(y(9)^(1+params(9))*exp(y(25))*getPowerDeriv(y(6),T66,1)));
  g1(4,7)=1-beta__*params(10)*T84^T66*exp(y(23)*T66);
  g1(4,9)=(-(exp(y(25))*y(6)^T66*getPowerDeriv(y(9),1+params(9),1)));
  g1(4,23)=(-(y(7)*(exp(y(23)*T66)*beta__*params(10)*getPowerDeriv(T84,T66,1)*T687+beta__*params(10)*T84^T66*T66*exp(y(23)*T66))));
  g1(4,25)=(-T71);
  g1(5,1)=(-(y(9)*T94));
  ...
  g1(6,3)=(-(params(10)*T83*(T107*T25*getPowerDeriv(T25*y(3),params(11),1)+T76*(-(y(6)/T25))/(y(3)*y(3)))*T441*T444));
  g1(6,5)=(-(T444*(1-params(10))*getPowerDeriv(y(5),T110,1)));
  g1(6,6)=1-T444*params(10)*T441*T83*T76*1/T25/y(3);
  g1(6,23)=(-(T444*params(10)*T441*T83*(T107*T25*y(3)*getPowerDeriv(T25*y(3),params(11),1)+T76*(-(T25*y(6)))/(T25*T25)/y(3))));
  ...
  g1(8,1)=(-(y(13)*T132*params(7)*T131^2*exp(y(26))*T389));
  g1(8,13)=(-(exp(y(26))*(T135-T132*params(7)*T131)+T132*params(7)*T27*exp(y(26))*T131^2));
  g1(8,23)=(-(y(13)*exp(y(26))*((-(params(7)/2*T131*2*T132))-(T132*params(7)*T131+T131*params(7)*T131))+y(13)*(T131*params(7)*T27*exp(y(26))*T131^2+T132*params(7)*(T131^2*exp(y(26))*T668+T27*exp(y(26))*T131*2*T131))));
  g1(8,26)=(-T152);
  ...
  g1(17,3)=(-(params(5)*T215*(1/y(3)*getPowerDeriv(y(3),params(6),1)+T212*(-1)/(y(3)*y(3)))*getPowerDeriv(T215*T212*1/y(3),T233,1)));
  g1(17,18)=(-((1-params(5))*getPowerDeriv(y(18),T233,1)));
  g1(17,27)=(-(params(5)*T234*exp(y(27))/(exp(y(27))*exp(y(27)))*log(T215*T212*1/y(3))+(1-params(5))*y(18)^T233*exp(y(27))/(exp(y(27))*exp(y(27)))*log(y(18))));
  g1(18,2)=((y(2))-y(2))/((y(2))*(y(2)))-T259*T254*((y(2))-y(2))/((y(2))*(y(2)))*getPowerDeriv(y(2)/(y(2)),params(15),1);
  g1(18,3)=(-(T259*T244*T251*1/pic_star__*getPowerDeriv(y(3)/pic_star__,params(13),1)*getPowerDeriv(T252,1-params(15),1)));
  g1(18,21)=(-(T259*T244*getPowerDeriv(T252,1-params(15),1)*T247*((y(21))-y(21))/((y(21))*(y(21)))*getPowerDeriv(y(21)/(y(21)),params(14),1)));
  g1(19,4)=(-1);
  ...
  g1(22,3)=(-(y(22)*params(5)*(y(3)*T215*getPowerDeriv(y(3),params(6),1)-T212*T215)/(y(3)*y(3))*getPowerDeriv(T212*T215/y(3),T292,1)));
  g1(22,18)=(-((1-params(5))*getPowerDeriv(y(18),T292,1)));
  g1(22,22)=1-T298;
  g1(22,27)=(-((1-params(5))*y(18)^T292*log(y(18))*T796+y(22)*params(5)*T297*T796*log(T212*T215/y(3))));
