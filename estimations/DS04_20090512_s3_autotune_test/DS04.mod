...
estimation(nodisplay, smoother, order=1, prefilter=0, datafile=data_20090512, xls_sheet=s3, xls_range=B1:BE101, presample=4, mh_replic=1000000, mh_nblocks=1, mh_drop=0.3, mh_tune_jscale=0.3, sub_draws=5000, forecast=40, mode_compute=6) gdp_rgd_obs gdpdef_obs;