...
estimation(nodisplay, smoother, order=1, prefilter=0, datafile=data_20081110, xls_sheet=s3, xls_range=B1:BD101, presample=4, mh_replic=10000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, sub_draws=1000, forecast=40, mode_compute=0, mode_file=A16_mode) gdp_rgd_obs;