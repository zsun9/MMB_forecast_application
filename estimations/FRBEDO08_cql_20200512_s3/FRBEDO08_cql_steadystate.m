...
function [ys,check] = FRBEDO08_cql_steadystate(ys,exe)
global M_
...
% rff_q_obs_frbedo = r;
gdp_rgd_obs = (hgdp-1)*100;
gdpdef_obs = (paipgdp-1)*100;
ffr_obs = (r-1)*100;

cnds_nom_obs = (paipc*gammaxc -1)*100;
cd_nom_obs  = (paipk*gammaxk -1)*100;
ir_nom_obs   = (paipc*gammaxc -1)*100;
inr_nom_obs  = (paipk*gammaxk -1)*100;
cnds_def_obs = (paipc -1)*100;
cd_def_obs = (paipk -1)*100;
wage_rgd_obs    = (paipc/paipgdp*gammaxc -1)*100;
hours_frbedo08_cql_obs   = 1;
