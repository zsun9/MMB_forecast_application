...
erase_compiled_function('WW11_static');
erase_compiled_function('WW11_dynamic');
M_.orig_eq_nbr = 16;
M_.eq_nbr = 16;
M_.ramsey_eq_nbr = 0;
...
options_.smoother = 1;
options_.sub_draws = 2500;
options_.datafile = 'data_20010214';
options_.mode_file = 'WW11_mode';
options_.xls_range = 'B1:D104';
