...
estimation(datafile=data_20010214, xls_sheet=s1, xls_range=B1:D104, presample=4,                 mh_replic=10000, mh_nblocks=1, mh_drop=0.3, mh_jscale=0.3,                 sub_draws=2500, forecast=10,                 order=1, prefilter=0, nograph, smoother, silent_optimizer,                 mode_compute=0, mode_file=WW11_mode) gdp_rgd_obs;