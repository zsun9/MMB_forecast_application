...
T(17) = params(12)/T(2);
T(18) = 1-T(17);
T(19) = params(11)*(1+T(17))/T(18)*y(60);
...
T(28) = params(33)/T(18);
T(29) = 1/T(18);
T(30) = (1-T(1)*params(34))*(1-params(34))/params(34);
T(31) = 1/(1+T(2)*T(4)*params(16));
T(32) = (1-params(17))*(1-T(2)*T(4)*params(17))/params(17)/(1+(params(13)-1)*params(2));
T(33) = params(18)*(1-T(2)*T(4)*params(15))*(1-params(15))/((1+T(2)*T(4))*params(15)*params(19)*params(18)/(params(19)-1));
T(34) = params(18)*(1-params(15))*(1+T(2)*T(4))*params(15)*params(19)*params(18)/(params(19)-1)/(1-T(2)*T(4)*params(15));
