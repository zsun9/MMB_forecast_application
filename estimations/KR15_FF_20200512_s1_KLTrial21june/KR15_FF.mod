...
var lambda, R, pic, c, w_tilda, w, phi_w, psi_w, L, k, k_bar, i, Q, d, n, R_e, r_k, u, R_d, 
    ...
    gdp_rgd_obs, c_rgd_obs, ifi_rgd_obs, hours_kr15_obs, wage_rgd_obs, gdpdef_obs, ffr_obs, dlnD, credit_nom_obs, bbb1yffr_obs;
...
varobs gdp_rgd_obs, c_rgd_obs, ifi_rgd_obs, hours_kr15_obs, wage_rgd_obs, gdpdef_obs, ffr_obs, credit_nom_obs, bbb1yffr_obs;
...
estimation(nodisplay, smoother, order=1, prefilter=0, mode_check, bayesian_irf, datafile=data_20200512, xls_sheet=s1, xls_range=B1:AN100, presample=4, mh_replic=1000000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, sub_draws=5000, forecast=40, mode_compute=6) gdp_rgd_obs;