...
residual(1) = lhs - rhs;
lhs = y(251);
rhs = y(300)*y(263)*T(13)+y(596)*T(52);
residual(2) = lhs - rhs;
lhs = T(12);
rhs = T(13)*y(263)*y(262)*y(300)*y(282)+T(54)*T(14);
residual(3) = lhs - rhs;
lhs = y(252);
rhs = y(256)*T(36)*y(300)*y(263)*(1-params(78))/params(34)+y(597)*T(61);
residual(4) = lhs - rhs;
lhs = T(15);
rhs = y(300)*T(62)*params(85)+T(63)*T(16);
residual(5) = lhs - rhs;
lhs = y(299);
rhs = T(64)^(1/T(59));
residual(6) = lhs - rhs;
lhs = y(279);
rhs = exp(params(61)*(y(296)-1))*T(2)*params(79);
residual(7) = lhs - rhs;
lhs = y(279);
rhs = y(282)*y(250)*params(16)*T(65);
residual(8) = lhs - rhs;
lhs = y(282);
rhs = T(68)/y(250);
residual(9) = lhs - rhs;
lhs = T(13);
rhs = y(247)+y(253)+y(258)/y(264)+y(6)*params(79)*T(17)/(y(265)*params(81))+T(18)+params(21)*(1-y(254))*(y(266)-params(82))/y(254);
residual(10) = lhs - rhs;
lhs = y(261);
rhs = y(6)*(1-params(23))/(y(265)*params(81))+y(258)*(1-T(19));
residual(11) = lhs - rhs;
lhs = 0;
...
residual(13) = lhs - rhs;
lhs = 0;
rhs = (1-T(20))*(1+y(606))/(1+y(276))+T(69)*T(70);
residual(14) = lhs - rhs;
lhs = 1+y(280);
rhs = y(270)*((1-params(77))*(y(279)*y(296)-params(79)*T(17))+(1-params(23))*y(275))/(y(14)*params(81))+params(23)*params(77);
residual(15) = lhs - rhs;
lhs = 0;
rhs = y(263)*(-y(300))/y(264)+y(300)*y(263)*y(275)*T(71)+params(20)*y(609)*y(600)*y(605)*T(24)*T(72)/(params(81)*y(601));
residual(16) = lhs - rhs;
lhs = log(y(276)/params(45));
rhs = params(57)*log(y(15)/params(45))+T(73)*params(39)*log(y(272)/params(39))+params(39)*T(73)*params(17)*(log(y(603))-log(y(272)))+T(74)*((params(22)*log(T(75))+params(29)*log(T(76))-params(29)*log(y(264)/y(8))+params(27)*log(y(253)/y(3)))/T(77)+T(78))+params(37)*T(73)*params(13)*(T(78)+log(y(261)*y(275)-y(266))-log(y(14)*y(6)-y(10)))+T(73)*params(14)*log(y(270)/y(11))-T(79)*(params(22)*log(y(247)/params(22))+params(29)*log(y(258)/params(29))-params(29)*log(y(264))+params(27)*log(y(253)/params(27)))/T(77)+1/(params(45)*400)*x(it_, 18);
residual(17) = lhs - rhs;
residual(18) = 1+(y(268)*(1-T(4))+T(3)*(1-params(35)))*(1+y(280))*y(14)*y(6)/(y(10)*(1+y(15)))-y(14)*y(6)/y(10);
lhs = y(266);
rhs = params(82)+y(14)*y(6)*T(82)+y(10)*y(254)*(1+y(15))/(y(270)*y(265));
residual(19) = lhs - rhs;
lhs = y(295);
rhs = T(83)*T(85);
residual(20) = lhs - rhs;
...
residual(36) = lhs - rhs;
lhs = log(y(253)/T(31));
rhs = params(47)*log(y(3)/T(31))+x(it_, 2);
residual(37) = lhs - rhs;
...
residual(45) = lhs - rhs;
lhs = log(y(283)/T(32));
rhs = params(53)*log(y(18)/T(32))+log(y(284))+log(y(19))+log(y(32))+log(y(34))+log(y(37))+log(y(41))+log(y(46))+log(y(52))+log(y(59));
residual(46) = lhs - rhs;
lhs = log(y(292));
rhs = params(74)*x(it_, 16);
residual(47) = lhs - rhs;
lhs = log(y(291));
rhs = x(it_, 16)*params(74)*params(38)+T(92)*x(it_, 15);
residual(48) = lhs - rhs;
lhs = log(y(290));
rhs = x(it_, 16)*params(74)*T(90)+x(it_, 15)*params(74)*params(38)*T(91)+T(92)*x(it_, 14);
residual(49) = lhs - rhs;
lhs = log(y(289));
rhs = x(it_, 16)*params(74)*T(93)+x(it_, 15)*params(74)*T(90)*T(91)+params(74)*params(38)*T(91)*x(it_, 14)+T(92)*x(it_, 13);
residual(50) = lhs - rhs;
lhs = log(y(288));
rhs = x(it_, 16)*params(74)*T(94)+x(it_, 15)*params(74)*T(91)*T(93)+x(it_, 14)*params(74)*T(90)*T(91)+params(74)*params(38)*T(91)*x(it_, 13)+T(92)*x(it_, 12);
residual(51) = lhs - rhs;
lhs = log(y(287));
rhs = x(it_, 16)*params(74)*T(95)+x(it_, 15)*params(74)*T(91)*T(94)+x(it_, 14)*params(74)*T(91)*T(93)+params(74)*T(90)*T(91)*x(it_, 13)+params(74)*params(38)*T(91)*x(it_, 12)+T(92)*x(it_, 11);
residual(52) = lhs - rhs;
lhs = log(y(286));
rhs = x(it_, 16)*params(74)*T(96)+x(it_, 15)*params(74)*T(91)*T(95)+x(it_, 14)*params(74)*T(91)*T(94)+x(it_, 13)*params(74)*T(91)*T(93)+params(74)*T(90)*T(91)*x(it_, 12)+params(74)*params(38)*T(91)*x(it_, 11)+T(92)*x(it_, 10);
residual(53) = lhs - rhs;
lhs = log(y(285));
rhs = x(it_, 16)*params(74)*T(97)+x(it_, 15)*params(74)*T(91)*T(96)+x(it_, 14)*params(74)*T(91)*T(95)+x(it_, 13)*params(74)*T(91)*T(94)+params(74)*T(91)*T(93)*x(it_, 12)+params(74)*T(90)*T(91)*x(it_, 11)+params(74)*params(38)*T(91)*x(it_, 10)+T(92)*x(it_, 9);
residual(54) = lhs - rhs;
lhs = log(y(284));
rhs = x(it_, 16)*T(98)+x(it_, 15)*params(69)*T(91)*T(97)+x(it_, 14)*T(91)*T(96)*params(69)+x(it_, 13)*T(91)*T(95)*params(69)+x(it_, 12)*T(91)*T(94)*params(69)+x(it_, 11)*T(91)*T(93)*params(69)+x(it_, 10)*T(90)*T(91)*params(69)+x(it_, 9)*params(38)*T(91)*params(69)+T(91)*params(69)*x(it_, 8);
residual(55) = lhs - rhs;
lhs = y(269);
rhs = (steady_state(23));
residual(56) = lhs - rhs;
