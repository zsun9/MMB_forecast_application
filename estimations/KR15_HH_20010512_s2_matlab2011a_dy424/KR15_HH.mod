...
estimation(nograph, smoother, order=1, prefilter=0, datafile=data_20010512, xls_sheet=s2, xls_range=B1:BD101, presample=4, mh_replic=100000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, forecast=40, mode_compute=6) gdp_rgd_obs;