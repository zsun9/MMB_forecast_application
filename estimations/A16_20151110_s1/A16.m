...
M_.endo_names = char(M_.endo_names, 'AUX_ENDO_LEAD_516');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_ENDO\_LEAD\_516');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_ENDO_LEAD_516');
M_.endo_names = char(M_.endo_names, 'AUX_ENDO_LEAD_808');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_ENDO\_LEAD\_808');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_ENDO_LEAD_808');
...
M_.endo_names = char(M_.endo_names, 'AUX_ENDO_LEAD_865');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_ENDO\_LEAD\_865');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_ENDO_LEAD_865');
M_.endo_names = char(M_.endo_names, 'AUX_ENDO_LEAD_879');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_ENDO\_LEAD\_879');
M_.endo_names_long = char(M_.endo_names_long, 'AUX_ENDO_LEAD_879');
...
M_.param_names = 'gdp_rgd_obs_mean';
M_.param_names_tex = 'gdp\_rgd\_obs\_mean';
M_.param_names_long = 'gdp_rgd_obs_mean';
...
gs_ss = M_.params( 20 );
M_.params( 21 ) = 3.52;
etau_q_ss = M_.params( 21 );
M_.params( 22 ) = 0.755;
theta_I = M_.params( 22 );
M_.params( 23 ) = 0.312;
pis = M_.params( 23 );
M_.params( 24 ) = 0.828;
rho_i = M_.params( 24 );
...
rho_g = M_.params( 30 );
M_.params( 31 ) = 0.986;
rho_tau = M_.params( 31 );
M_.params( 32 ) = 0.771;
decay = M_.params( 32 );
M_.params( 33 ) = 0.487;
rho_beta = M_.params( 33 );
M_.params( 34 ) = 0.707;
rho_p = M_.params( 34 );
M_.params( 35 ) = 0.159;
rho_w = M_.params( 35 );
M_.params( 36 ) = 0.194;
theta_p = M_.params( 36 );
M_.params( 37 ) = 0.148;
theta_w = M_.params( 37 );
M_.params( 38 ) = 0.601;
s_z = M_.params( 38 );
M_.params( 39 ) = 0.153;
s_g = M_.params( 39 );
...
s_w = M_.params( 47 );
M_.params( 48 ) = 0.025;
s_meas_sp = M_.params( 48 );
M_.params( 49 ) = 0.148;
s_meas = M_.params( 49 );
M_.params( 50 ) = 0.6250;
rho_phi = M_.params( 50 );
M_.params( 43 ) = 0;
s_phi = M_.params( 43 );
par_ss(1)   = gam_s;
par_ss(2)   = bet_s;
...
%
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = M_.params(38)^2;
M_.Sigma_e(2, 2) = M_.params(39)^2;
M_.Sigma_e(3, 3) = M_.params(40)^2;
M_.Sigma_e(4, 4) = M_.params(41)^2;
M_.Sigma_e(5, 5) = M_.params(42)^2;
M_.Sigma_e(6, 6) = M_.params(43)^2;
M_.Sigma_e(7, 7) = M_.params(45)^2;
M_.Sigma_e(8, 8) = M_.params(46)^2;
M_.Sigma_e(9, 9) = M_.params(47)^2;
...
estim_params_.var_exo = [estim_params_.var_exo; 1, 0.6142, 0, NaN, 6, 0.50, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 2, 0.1518, 0, NaN, 6, 0.50, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 3, 0.4441, 0, NaN, 6, 0.10, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 4, 0.2274, 0, NaN, 6, 0.50, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 5, 0.2491, 0, NaN, 6, 0.50, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 7, 1.1614, 0, NaN, 6, 0.50, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 8, 0.0641, 0, NaN, 6, 0.10, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 9, 0.2961, 0, NaN, 6, 0.10, 1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 10, 0.1, 0, NaN, 6, 0.05, 0.05, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 11, 0.0300, 0, NaN, 6, 0.05, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 3, 0.7549, NaN, NaN, 2, 0.75, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 5, 1.8823, NaN, NaN, 2, 2, 0.75, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 6, 0.7355, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 8, 0.7296, 0, 1, 1, 0.60, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 10, 0.8829, 0, 1, 1, 0.75, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 11, 0.0965, 0, 1, 1, 0.50, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 13, 0.8940, 0, 1, 1, 0.75, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 14, 0.4723, 0, 1, 1, 0.50, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 16, 0.0147, 0.0131, 0.017, 2, 0.40, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 18, 0.5, 0, 1, 1, 0.75, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 22, 1.4534, 0, NaN, 2, 4, 2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 23, 0.5893, NaN, NaN, 2, 0.50, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 24, 0.9525, 0, 1, 1, 0.85, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 25, 0.5689, 0, NaN, 3, 0.70, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 26, 0.1152, NaN, NaN, 3, 0.125, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 28, 0.3, 0, NaN, 2, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 29, 0.3156, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 30, 0.9897, 0, 1.01, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 33, 0.6212, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 31, 0.95, NaN, NaN, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 32, 0.60, 0, NaN, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 34, 0.6182, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 35, 0.1874, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 36, 0.2155, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 37, 0.1161, 0, 1, 1, 0.50, 0.20, NaN, NaN, NaN ];
...
if isempty(tmp1)
    ...
    estim_params_.param_vals(tmp1,2) = 0.0147;
end
...
options_.datafile = 'data_20151110';
options_.xls_range = 'B1:Z100';
