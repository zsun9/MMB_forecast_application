...
//%end;
estimation(nodisplay, smoother, order=1, prefilter=0, mode_check, bayesian_irf, prior_trunc = 0, datafile=data_20210209, xls_sheet=s2, xls_range=B1:AY101, presample=4, mh_replic=1000000, mh_nblocks=1, mh_drop=0.3, mh_tune_jscale=0.3, sub_draws=1000, forecast=40, mode_compute=6) gdpl_rgd_obs pi_dm_obs;