...
estimation(nodisplay, smoother, order=1, prefilter=0, mode_check, bayesian_irf, datafile=data_20090512_ew64q1, xls_sheet=s1, xls_range=B1:Z182, presample=4, mh_replic=500000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.4, sub_draws=5000, forecast=100, mode_compute=1) gdpl_rgd_obs;