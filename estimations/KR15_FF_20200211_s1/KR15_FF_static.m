function [residual, g1, g2, g3] = KR15_FF_static(y, x, params)
%
...
T494 = (y(1)*beta__/T25-beta__*y(1)/T25)/(y(1)*y(1));
T535 = getPowerDeriv(T25*y(3),params(11),1);
T541 = (T76-y(3)*T25*T535)/(T76*T76)/T83;
T542 = getPowerDeriv(T84,T66,1);
T548 = getPowerDeriv(T84,T97,1);
T560 = getPowerDeriv(T83*T76*T107,T110,1);
T563 = getPowerDeriv(T116,(-params(2)),1);
T571 = getPowerDeriv(y(3),params(6),1);
T576 = (T264-y(3)*T571)/(T264*T264)/T267;
T600 = getPowerDeriv(T304,1-params(15),1);
T662 = getPowerDeriv(y(17)/y(6),params(4),1);
T670 = getPowerDeriv(y(6)/y(17),1-params(4),1);
T865 = 1/y(23)/exp(y(37));
T872 = exp((-(T364*T364))/2)/2.506628274631;
T879 = exp((-((T364-exp(y(37)))*(T364-exp(y(37)))))/2)/2.506628274631;
T931 = (-(beta__*y(1)*T25))/(T25*T25)/y(1);
T950 = (-(y(3)*T25*y(3)*T535))/(T76*T76)/T83;
T1067 = (exp(y(34))*(-exp(y(34)))-exp(y(34))*(-(1+exp(y(34)))))/(exp(y(34))*exp(y(34)));
T1105 = (exp(y(37))*0.5*exp(y(37))*2*exp(y(37))-exp(y(37))*T363)/(exp(y(37))*exp(y(37)));
  g1(1,1)=y(2)*T494/y(3);
  g1(1,2)=T27/y(3);
  g1(1,3)=(-(T27*y(2)))/(y(3)*y(3));
  g1(1,30)=y(2)*T931/y(3);
  g1(2,1)=1;
  ...
  g1(4,3)=(-(y(7)*exp(y(30)*T66)*beta__*params(10)*T541*T542));
  g1(4,6)=(-(T70*exp(y(32))*getPowerDeriv(y(6),T66,1)));
  g1(4,7)=1-T89;
  g1(4,9)=(-(T68*getPowerDeriv(y(9),1+params(9),1)));
  g1(4,30)=(-(y(7)*(exp(y(30)*T66)*beta__*params(10)*T542*T950+T86*T66*exp(y(30)*T66))));
  g1(4,32)=(-(T68*T70));
  g1(5,1)=(-(y(9)*T94));
  g1(5,3)=(-(y(8)*T101*beta__*params(10)*T541*T548));
  g1(5,6)=(-(y(9)*y(1)*getPowerDeriv(y(6),(1+params(2))/params(2),1)));
  g1(5,8)=1-T102;
  g1(5,9)=(-(y(1)*T94));
  g1(5,30)=(-(y(8)*(T101*beta__*params(10)*T548*T950+T99*T97*T101)));
  g1(6,3)=(-(params(10)*T83*(T107*T25*T535+T76*(-(y(6)/T25))/(y(3)*y(3)))*T560*T563));
  g1(6,5)=(-(T563*(1-params(10))*getPowerDeriv(y(5),T110,1)));
  g1(6,6)=1-T563*params(10)*T560*T83*T76*1/T25/y(3);
  g1(6,30)=(-(T563*params(10)*T560*T83*(T107*T25*y(3)*T535+T76*(-(T25*y(6)))/(T25*T25)/y(3))));
  ...
  g1(8,1)=(-(y(13)*T132*params(7)*T147*exp(y(33))*T494));
  g1(8,13)=(-(exp(y(33))*(T135-T132*params(7)*T131)+T132*params(7)*T27*exp(y(33))*T147));
  g1(8,30)=(-(y(13)*exp(y(33))*((-(params(7)/2*T131*2*T132))-(T132*params(7)*T131+T131*params(7)*T131))+y(13)*(T131*params(7)*T27*exp(y(33))*T147+T132*params(7)*(T147*exp(y(33))*T931+T27*exp(y(33))*T131*2*T131))));
  ...
  g1(19,1)=(-(y(24)*y(28)));
  g1(19,3)=(-(y(26)*beta__*params(5)*T576*getPowerDeriv(T268,(1+exp(y(34)))/exp(y(34)),1)));
  g1(19,24)=(-(y(1)*y(28)));
  g1(19,26)=1-T271;
  g1(19,28)=(-(y(1)*y(24)));
  g1(19,34)=(-(y(26)*beta__*params(5)*T270*(exp(y(34))*exp(y(34))-exp(y(34))*(1+exp(y(34))))/(exp(y(34))*exp(y(34)))*log(T268)));
  g1(20,1)=(-y(28));
  g1(20,3)=(-(y(27)*beta__*params(5)*T576*getPowerDeriv(T268,1/exp(y(34)),1)));
  g1(20,27)=1-T278;
  g1(20,28)=(-y(1));
  g1(20,34)=(-(y(27)*beta__*params(5)*T277*log(T268)*(-exp(y(34)))/(exp(y(34))*exp(y(34)))));
  g1(21,3)=(-(params(5)*T267*(1/y(3)*T571+T264*(-1)/(y(3)*y(3)))*getPowerDeriv(T267*T264*1/y(3),T285,1)));
  ...
  g1(22,3)=(-(T311*T296*T303*1/pic_star__*getPowerDeriv(y(3)/pic_star__,params(13),1)*T600));
  g1(22,28)=(-(T311*T296*T600*T299*((y(28))-y(28))/((y(28))*(y(28)))*getPowerDeriv(y(28)/(y(28)),params(14),1)));
  ...
  g1(24,6)=(-(y(29)*y(28)*T328*(-y(17))/(y(6)*y(6))*T662/exp(y(36))));
  g1(24,9)=1;
  g1(24,17)=(-(y(29)*y(28)*T328*T662*1/y(6)/exp(y(36))));
  g1(24,28)=(-(y(29)*T331/exp(y(36))));
  g1(24,29)=(-(y(28)*T331/exp(y(36))));
  g1(24,36)=(-(y(29)*(-(exp(y(36))*y(28)*T331))/(exp(y(36))*exp(y(36)))));
  g1(25,6)=(-(y(29)*y(28)*T338*1/y(17)*T670/exp(y(36))));
  g1(25,10)=1;
  g1(25,17)=(-(y(29)*y(28)*T338*T670*(-y(6))/(y(17)*y(17))/exp(y(36))));
  g1(25,28)=(-(y(29)*T341/exp(y(36))));
  g1(25,29)=(-(y(28)*T341/exp(y(36))));
  g1(25,36)=(-(y(29)*(-(exp(y(36))*y(28)*T341))/(exp(y(36))*exp(y(36)))));
  g1(26,3)=(-(y(29)*params(5)*(y(3)*T267*T571-T264*T267)/(y(3)*y(3))*getPowerDeriv(T264*T267/y(3),T347,1)));
  g1(26,25)=(-((1-params(5))*getPowerDeriv(y(25),T347,1)));
  g1(26,29)=1-T353;
  g1(26,34)=(-((1-params(5))*T348*log(y(25))*T1067+y(29)*params(5)*T352*T1067*log(T264*T267/y(3))));
  g1(27,20)=1;
  g1(27,23)=(-(T865*T872));
  g1(27,37)=(-(T872*T1105));
  g1(28,21)=1;
  g1(28,23)=(-(T865*T879));
  g1(28,37)=(-(T879*(T1105-exp(y(37)))));
  g1(29,22)=1;
  g1(29,23)=(-((y(23)*T370*T364*(-T865)-T370)/(y(23)*y(23))/exp(y(37))));
  g1(29,37)=(-((exp(y(37))*T370*T364*(-T1105)/y(23)-exp(y(37))*T370/y(23))/(exp(y(37))*exp(y(37)))));
