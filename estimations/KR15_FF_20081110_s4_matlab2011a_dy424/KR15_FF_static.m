function [residual, g1, g2] = KR15_FF_static(y, x, params)
%
...
T71 = exp(y(32))*y(6)^T66*y(9)^(1+params(9));
...
T152 = exp(y(33))*(T135-T132*params(7)*T131)*y(13)+y(13)*T132*params(7)*T27*exp(y(33))*T131^2;
...
T950 = (-(y(3)*T25*y(3)*getPowerDeriv(T25*y(3),params(11),1)))/(T76*T76)/T83;
T1067 = (exp(y(34))*(-exp(y(34)))-exp(y(34))*(-(1+exp(y(34)))))/(exp(y(34))*exp(y(34)));
T1105 = (exp(y(37))*0.5*exp(y(37))*2*exp(y(37))-exp(y(37))*(log(y(23))+0.5*exp(y(37))^2))/(exp(y(37))*exp(y(37)));
lhs =T27*y(2)/y(3);
rhs =1;
residual(1)= lhs-rhs;
lhs =y(1);
...
residual(3)= lhs-rhs;
lhs =y(7);
rhs =T71+y(7)*beta__*params(10)*T84^T66*exp(y(30)*T66);
residual(4)= lhs-rhs;
lhs =y(8);
...
residual(20)= lhs-rhs;
lhs =1;
rhs =params(5)*T286+(1-params(5))*y(25)^T285;
residual(21)= lhs-rhs;
lhs =y(2)/(y(2));
rhs =T296*T306*T311;
residual(22)= lhs-rhs;
...
residual(25)= lhs-rhs;
lhs =y(29);
rhs =(1-params(5))*y(25)^T347+y(29)*T353;
residual(26)= lhs-rhs;
lhs =y(20);
...
%
  ...
  g1(4,3)=(-(y(7)*exp(y(30)*T66)*beta__*params(10)*T541*getPowerDeriv(T84,T66,1)));
  g1(4,6)=(-(y(9)^(1+params(9))*exp(y(32))*getPowerDeriv(y(6),T66,1)));
  g1(4,7)=1-beta__*params(10)*T84^T66*exp(y(30)*T66);
  g1(4,9)=(-(exp(y(32))*y(6)^T66*getPowerDeriv(y(9),1+params(9),1)));
  g1(4,30)=(-(y(7)*(exp(y(30)*T66)*beta__*params(10)*getPowerDeriv(T84,T66,1)*T950+beta__*params(10)*T84^T66*T66*exp(y(30)*T66))));
  g1(4,32)=(-T71);
  g1(5,1)=(-(y(9)*T94));
  ...
  g1(6,3)=(-(params(10)*T83*(T107*T25*getPowerDeriv(T25*y(3),params(11),1)+T76*(-(y(6)/T25))/(y(3)*y(3)))*T560*T563));
  g1(6,5)=(-(T563*(1-params(10))*getPowerDeriv(y(5),T110,1)));
  g1(6,6)=1-T563*params(10)*T560*T83*T76*1/T25/y(3);
  g1(6,30)=(-(T563*params(10)*T560*T83*(T107*T25*y(3)*getPowerDeriv(T25*y(3),params(11),1)+T76*(-(T25*y(6)))/(T25*T25)/y(3))));
  ...
  g1(8,1)=(-(y(13)*T132*params(7)*T131^2*exp(y(33))*T494));
  g1(8,13)=(-(exp(y(33))*(T135-T132*params(7)*T131)+T132*params(7)*T27*exp(y(33))*T131^2));
  g1(8,30)=(-(y(13)*exp(y(33))*((-(params(7)/2*T131*2*T132))-(T132*params(7)*T131+T131*params(7)*T131))+y(13)*(T131*params(7)*T27*exp(y(33))*T131^2+T132*params(7)*(T131^2*exp(y(33))*T931+T27*exp(y(33))*T131*2*T131))));
  g1(8,33)=(-T152);
  g1(9,11)=(-y(13));
  g1(9,13)=(-y(11));
  g1(9,14)=1;
  ...
  g1(21,3)=(-(params(5)*T267*(1/y(3)*getPowerDeriv(y(3),params(6),1)+T264*(-1)/(y(3)*y(3)))*getPowerDeriv(T267*T264*1/y(3),T285,1)));
  g1(21,25)=(-((1-params(5))*getPowerDeriv(y(25),T285,1)));
  g1(21,34)=(-(params(5)*T286*exp(y(34))/(exp(y(34))*exp(y(34)))*log(T267*T264*1/y(3))+(1-params(5))*y(25)^T285*exp(y(34))/(exp(y(34))*exp(y(34)))*log(y(25))));
  g1(22,2)=((y(2))-y(2))/((y(2))*(y(2)))-T311*T306*((y(2))-y(2))/((y(2))*(y(2)))*getPowerDeriv(y(2)/(y(2)),params(15),1);
  g1(22,3)=(-(T311*T296*T303*1/pic_star__*getPowerDeriv(y(3)/pic_star__,params(13),1)*getPowerDeriv(T304,1-params(15),1)));
  g1(22,28)=(-(T311*T296*getPowerDeriv(T304,1-params(15),1)*T299*((y(28))-y(28))/((y(28))*(y(28)))*getPowerDeriv(y(28)/(y(28)),params(14),1)));
  ...
  g1(26,3)=(-(y(29)*params(5)*(y(3)*T267*getPowerDeriv(y(3),params(6),1)-T264*T267)/(y(3)*y(3))*getPowerDeriv(T264*T267/y(3),T347,1)));
  g1(26,25)=(-((1-params(5))*getPowerDeriv(y(25),T347,1)));
  g1(26,29)=1-T353;
  g1(26,34)=(-((1-params(5))*y(25)^T347*log(y(25))*T1067+y(29)*params(5)*T352*T1067*log(T264*T267/y(3))));
  g1(27,20)=1;
  g1(27,23)=(-(T865*T872));
  g1(27,37)=(-(T872*T1105));
  g1(28,21)=1;
