...
estimation(nodisplay, smoother, order=1, prefilter=0, datafile=data_20200812, xls_sheet=s2, xls_range=B1:BE101, presample=4, mh_replic=500000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, sub_draws=5000, forecast=40, mode_compute=1) gdp_rgd_obs;