...
estimation(nograph, smoother, order=1, prefilter=0, datafile=data_20010815, xls_sheet=s3, xls_range=B1:AY101, presample=4, mh_replic=100000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, forecast=40, mode_compute=0, mode_file=KR15_HH_mode) gdp_rgd_obs;