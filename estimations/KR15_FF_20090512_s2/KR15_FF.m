...
M_.endo_names_long = char(M_.endo_names_long, 'credit_nom_obs');
M_.endo_names = char(M_.endo_names, 'bbb1yffr_obs');
M_.endo_names_tex = char(M_.endo_names_tex, 'bbb1yffr\_obs');
M_.endo_names_long = char(M_.endo_names_long, 'bbb1yffr_obs');
...
options_.varobs(8)  = {'credit_nom_obs'};
options_.varobs(9)  = {'bbb1yffr_obs'};
...
erase_compiled_function('KR15_FF_static');
...
if exist('estim_params_', 'var') == 1
  save('KR15_FF_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('KR15_FF_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('KR15_FF_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('KR15_FF_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('KR15_FF_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('KR15_FF_results.mat', 'oo_recursive_', '-append');
end
