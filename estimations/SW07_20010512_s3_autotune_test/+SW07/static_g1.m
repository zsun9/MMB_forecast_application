...
if T_flag
    T = SW07.static_g1_tt(T, y, x, params);
end
g1 = zeros(40, 40);
g1(1,11)=(-params(9));
g1(1,18)=(-(1-params(9)));
...
g1(15,23)=1;
g1(15,40)=(-1);
g1(16,24)=(-(T(18)*1/T(20)));
g1(16,35)=(-1);
g1(17,22)=(-(T(5)/(1-params(12)+T(5))));
g1(17,24)=1-T(23);
g1(17,29)=(-1);
g1(17,31)=1;
g1(17,33)=(-(1/T(22)));
...
g1(20,32)=(-params(17));
g1(21,20)=(-(T(24)*T(25)));
g1(21,29)=1-T(24)*(T(2)*T(12)+params(20));
g1(21,37)=(-1);
g1(22,25)=(-(T(27)*T(29)));
g1(22,28)=(-(params(22)*T(27)));
g1(22,29)=(-(T(26)+params(18)/(1+T(2)*T(12))-(1+T(2)*T(12)*params(18))/(1+T(2)*T(12))));
g1(22,30)=1-(T(18)+T(26)-T(27));
g1(22,38)=(-1);
