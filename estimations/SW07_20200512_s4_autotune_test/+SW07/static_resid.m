...
residual(4) = lhs - rhs;
lhs = y(15);
rhs = y(35)+T(10)*(y(15)+y(15)*T(9)+y(13)*1/T(12));
residual(5) = lhs - rhs;
lhs = y(13);
...
residual(15) = lhs - rhs;
lhs = y(26);
rhs = y(35)+T(10)*(y(26)+T(9)*y(26)+1/T(12)*y(24));
residual(16) = lhs - rhs;
lhs = y(24);
...
residual(21) = lhs - rhs;
lhs = y(30);
rhs = y(38)+T(10)*y(30)+y(30)*T(16)+y(29)*params(18)/(1+T(9))-y(29)*(1+T(9)*params(18))/(1+T(9))+y(29)*T(16)+T(17)*(params(22)*y(28)+1/(1-T(13))*y(25)-T(13)/(1-T(13))*y(25)-y(30));
residual(22) = lhs - rhs;
lhs = y(31);
