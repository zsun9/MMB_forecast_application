...
%%% observables %%%
    ...
    hours_dngs15_cql_obs           $L^{obs}$           % 29    => hours worked, observed
...
hours_dngs15_cql_obs        =  L_t +  Lmean;
...
varobs gdp_rgd_obs hours_dngs15_cql_obs wage_rgd_obs gdpdef_obs ffr_obs c_rgd_obs ifi_rgd_obs baag10_obs;
...
estimation(nodisplay, smoother, order=1, prefilter=0, datafile=data_20081110, xls_sheet=s3, xls_range=B1:BE101, presample=4, mh_replic=500000, mh_nblocks=1, mh_jscale=0.3, mh_drop=0.3, sub_draws=5000, forecast=40, mode_compute=0, mode_file=DNGS15_cql_nofa_mode) gdp_rgd_obs;