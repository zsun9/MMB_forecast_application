...
% "2001-02-14", "2001-05-12", "2001-08-15", "2001-11-14","2008-08-07", "2008-11-10", "2009-02-11", "2009-05-12",
p.scenarios = ["s3" ]; %"s2", "s4", "s1", "s3"
p.models = ["WW11"]; % "DS04", "WW11"
p.executor = "Jisu Jeun";
