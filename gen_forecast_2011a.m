...
p.vintages = transpose(cellstr(['2020-05-12']));
p.scenarios = transpose(cellstr(['s1';'s2';'s3';'s4']));

p.models = transpose(cellstr(['TRIAL20']));% "DS04", "WW11", "NKBGG", "DNGS15", "SW07", "QPM08", "KR15_FF"
p.executor = 'Zexi Sun';
